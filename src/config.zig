...
pub const Config = struct {
    ...
    proposal_promote_threshold: i64 = 8,
    ...
    pub fn load(allocator: std.mem.Allocator) !Config {
        ...
        const promote_threshold_str = getEnv(allocator, env_content, "PIPELINE_PROPOSAL_THRESHOLD") orelse "8";
        ...
        var config = Config{
            ...
            .proposal_promote_threshold = std.fmt.parseInt(i64, promote_threshold_str, 10) catch 8,
